...
describe('SyllabusTree — Task 11 (peso e quantidade são por cargo, nunca um campo só)', () => {
  it('com um cargo específico selecionado, os campos são editáveis e refletem a ligação daquele cargo', () => {
    const { getByTestId } = render(
      <SyllabusTree syllabus={SYLLABUS} cargoId="c1" onRename={noop} onRemove={noop} onAdd={noop} onSplit={noop} onWeightChange={noop} onQuestionCountChange={noop} />,
    );
  ...
  it('editar o peso com um cargo selecionado chama onWeightChange com aquele cargo, não outro', () => {
    ...
    const { getByTestId } = render(
      <SyllabusTree syllabus={SYLLABUS} cargoId="c2" onRename={noop} onRemove={noop} onAdd={noop} onSplit={noop} onWeightChange={onWeightChange} onQuestionCountChange={noop} />,
    );
  ...
  it('com "todos os cargos" (cargoId null), os campos ficam desabilitados e mostram o consolidado — maior peso, não a soma', () => {
    const { getByTestId } = render(
      <SyllabusTree syllabus={SYLLABUS} cargoId={null} onRename={noop} onRemove={noop} onAdd={noop} onSplit={noop} onWeightChange={noop} onQuestionCountChange={noop} />,
    );
    const weightInput = getByTestId('input-peso-materia-1') as HTMLInputElement;
    const questionsInput = getByTestId('input-questoes-materia-1') as HTMLInputElement;
  ...
  it('renomear via o menu de três pontos chama onRename com o novo rótulo', () => {
    ...
    const { getByTestId } = render(
      <SyllabusTree syllabus={SYLLABUS} cargoId={null} onRename={onRename} onRemove={noop} onAdd={noop} onSplit={noop} onWeightChange={noop} onQuestionCountChange={noop} />,
    );
  ...
  it('excluir via o menu de três pontos chama onRemove com o itemId', () => {
    ...
    const { getByTestId } = render(
      <SyllabusTree syllabus={SYLLABUS} cargoId={null} onRename={noop} onRemove={onRemove} onAdd={noop} onSplit={noop} onWeightChange={noop} onQuestionCountChange={noop} />,
    );
  ...
  it('"adicionar tópico" chama onAdd com o id da matéria pai; "adicionar matéria" chama com null', () => {
    const onAdd = vi.fn();
    const { getByTestId } = render(
      <SyllabusTree syllabus={SYLLABUS} cargoId={null} onRename={noop} onRemove={noop} onAdd={onAdd} onSplit={noop} onWeightChange={noop} onQuestionCountChange={noop} />,
    );
  ...
  it('filtra itens pelo cargo selecionado — item sem ligação com o cargo não aparece', () => {
    const { queryByTestId } = render(
      <SyllabusTree syllabus={SYLLABUS} cargoId="c2" onRename={noop} onRemove={noop} onAdd={noop} onSplit={noop} onWeightChange={noop} onQuestionCountChange={noop} />,
    );
