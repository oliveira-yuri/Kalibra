...
export function Home({ theme, onToggleTheme }: { theme: 'light' | 'dark'; onToggleTheme: () => void }) {
  ...
  return (
    <div className={`min-h-[100dvh] flex flex-col font-sans transition-colors ${dark ? 'bg-[#10131a] text-[#f0f0e8] selection:bg-[#283322]' : 'bg-[#f6f8f7] text-[#16232b] selection:bg-[#e5eed5]'}`}>
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 text-center py-20">
        ...
        <div className="mt-24 grid sm:grid-cols-3 gap-8 max-w-[900px] text-left">
          <div className={`k-card p-6 ${dark ? '!bg-[#131821] !border-[#242c37]' : '!bg-white !border-[#d5dede]'}`}>
